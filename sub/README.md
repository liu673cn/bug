...
```网站分类
{
  ...
  "shouye": "1",
  // 网站列表分类                
  "fenlei": "电影$/show/1--------#剧集$/show/2--------#动漫$/show/3--------#综艺$/show/4--------#动作$/show/6--------#喜剧$/show/7--------#爱情$/show/8--------#科幻$/show/9--------#恐怖$/show/10--------#剧情$/show/11--------#战争$/show/12--------#动画$/show/23--------#国产剧$/show/13--------#港台剧$/show/14--------#日韩剧$/show/15--------#欧美剧$/show/16--------#纪录片$/show/21--------#泰国剧$/show/24--------",
  // 网站翻页链接的后缀
  "houzhui": "---.html",
```
